...
a1 <- garch.sim(alpha = c(0.01, 0.4), beta = 0.1, n = 8000)
b1 <- garch.sim(alpha = c(0.01, 0.4), beta = 0.1, n = 8000)
df1 <- cbind(a1, b1)
a2 <- garch.sim(alpha = c(0.01, 0.4), beta = 0.1, n = 8000)
b2 <- garch.sim(alpha = c(0.01, 0.4), beta = 0.1, n = 8000)
df2 <- cbind(a2, b2)
a3 <- garch.sim(alpha = c(0.01, 0.4), beta = 0.1, n = 8000)
b3 <- garch.sim(alpha = c(0.01, 0.4), beta = 0.1, n = 8000)
df3 <- cbind(a3, b3)
