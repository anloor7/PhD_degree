...
a1 <- garch.sim(alpha = c(0.01, 0.5), beta = 0.4, n = 8000)
b1 <- garch.sim(alpha = c(0.01, 0.7), beta = 0.1, n = 8000)
df1 <- cbind(a1, b1)
a2 <- garch.sim(alpha = c(0.01, 0.1), beta = 0.3, n = 8000)
b2 <- garch.sim(alpha = c(0.01, 0.1), beta = 0.6, n = 8000)
df2 <- cbind(a2, b2)
a3 <- garch.sim(alpha = c(0.01, 0.3), beta = 0.3, n = 8000)
b3 <- garch.sim(alpha = c(0.01, 0.3), beta = 0.3, n = 8000)
df3 <- cbind(a3, b3)
a4 <- garch.sim(alpha = c(0.01, 0.3), beta = 0.3, n = 8000)
b4 <- garch.sim(alpha = c(0.01, 0.3), beta = 0.3, n = 8000)
df4 <- cbind(a4, b4)
