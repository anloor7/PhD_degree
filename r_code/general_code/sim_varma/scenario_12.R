...
theta_c1 <- matrix(c(0.3, 0, 0, 0.2, 0, 0, 0, 0.3, -0.3), nrow = 3)
sigma_c1 <- matrix(c(1, 0.25, 0.1, 0.25, 1, 0.25, 0.10, 0.25, 1), nrow = 3)
theta_c2 <- matrix(c(0.35, 0, 0, 0.25, 0, 0, 0, 0.35, -0.25), nrow = 3)
sigma_c2 <- matrix(c(1, 0.25, 0.1, 0.25, 1, 0.25, 0.10, 0.25, 1), nrow = 3)
theta_c3 <- matrix(c(0.25, 0, 0, 0.15, 0, 0, 0, 0.25, -0.35), nrow = 3)
...
for (i in 1 : 100) {
  cluster3[[i]] <- VARMAsim(200, malags = 1, theta = theta_c3,
